    ...
    <div className="db_page">
      <div className="left-container">
        ...
        <ul className={`main-menu ${showMenu ? 'show' : ''}`}>
          <NavLink to="/"  onClick={closeMenu}> <li><Home className="MuiSvgIcon-root"/> <Trans i18nKey="description.menupart1"> Home Page</Trans></li> </NavLink>
          ...
          <PersonOutlineIcon className="MuiSvgIcon-root"/>  <Trans i18nKey="description.menupart2">Profile</Trans>
            {showSubMenu && (
              <ul className="sub-menu">
                ...
                <NavLink to="/invoiceaddress" onClick={closeMenu}><li onClick={toggleMenu}><LocationOnOutlinedIcon className="MuiSvgIcon-root"/> <Trans i18nKey="description.menupart4">Invoice Addresses</Trans></li> </NavLink>
          ...
          <NavLink to="/calculateprice" onClick={closeMenu}><li onClick={toggleMenu}> <AttachMoneyIcon className="MuiSvgIcon-root"/><Trans i18nKey="description.menupart8">Calculate Price</Trans> </li> </NavLink>
          <NavLink to="/shipping" onClick={closeMenu}><li onClick={toggleMenu}><Truck className="MuiSvgIcon-root"/> <Trans i18nKey="description.menupart9"> Shippings</Trans> </li> </NavLink>
